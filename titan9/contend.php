...
<body id="page-top">
    ...
    <div id="wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6" style="height: 200px;">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <form action="contend.php?post=<?php echo $post_id; ?>" method="post">
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            $post_id = $_GET['post'];
                                            if ($tag_title !== '') {
                                                $update = Post::qurey("INSERT INTO contend (p_id,con_title) VALUES ($post_id,'$tag_title')");
                                                // header('location:status.php');
                                            }
                                        }
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['post'])) {
                                                    $post_id = $_GET['post'];
                                                    $cat_qurey = Post::qurey("SELECT * FROM contend WHERE p_id=$post_id");
                                                    while ($row = mysqli_fetch_assoc($cat_qurey)) {
                                                        $tag_id = $row['id'];
                                                        // $tag_post_id = $row['con_title'];
                                                        $tags_title = $row['con_title'];
                                                        echo "<tr>
                <td>$tag_id</td>
                <td>$tags_title</td>
                <td><a href='contend.php?delete=$tag_id'>Delete</a></td> ";
                                                    }
                                                }
                                                ?>
                                            </tbody>
        ...
        if (isset($_GET['delete'])) {
            $del_id = $_GET['delete'];
            $del = Post::qurey("DELETE FROM contend WHERE id=$del_id");
            header("Refresh:0");
