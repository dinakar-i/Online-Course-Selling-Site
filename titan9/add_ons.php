...
<body id="page-top">
    ...
    <div id="wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6" style="height: 200px;">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Add ADD ONS</h6>

                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <form action="add_ons.php" method="post">
                            ...
                            <div class="col-xl-6 col-lg-6   ">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">ADD ONS LIST</h6>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $select_con = POST::select_all_table('props');
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="add_ons.php?v=<?php echo $id; ?>">Remove</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
        ...
        if (isset($_POST['submit'])) {
            ...
            $title = $_POST['title'];
            if ($path !== '' && $title !== '') {
                $insert_con = POST::insert_add_ons($title, $path);
                if ($insert_con) {
        ...
        if (isset($_GET['v'])) {
            $dell_id = $_GET['v'];
            $dell_con = POST::delete('props', 'id', $dell_id);
            if ($dell_con) {
                header('location:add_ons.php');
            } else {
                echo "Query faild";
